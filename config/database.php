    ...
    */
    ...
    'connections' => [
        ...
        'mysql' => [
            ...
            'strict' => true,
            'engine' => null,
            'sslmode' => env('DB_SSLMODE', 'VERIFY_IDENTITY'),
        ...
        'staging_mysql' => [
            ...
            'unix_socket' => env('STAGING_B_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
            'prefix_indexes' => true,
            'strict' => true,
            'engine' => null,
            'sslmode' => env('STAGING_DB_SSLMODE', 'VERIFY_IDENTITY'),
            'options' => extension_loaded('pdo_mysql') ? array_filter([
                PDO::MYSQL_ATTR_SSL_CA => env('STAGING_MYSQL_ATTR_SSL_CA'),
            ]) : [],
        ],
        ...
        'production_mysql' => [
            ...
            'unix_socket' => env('PRODUCTION_B_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
            'prefix_indexes' => true,
            'strict' => true,
            'engine' => null,
            'sslmode' => env('PRODUCTION_DB_SSLMODE', 'VERIFY_IDENTITY'),
            'options' => extension_loaded('pdo_mysql') ? array_filter([
