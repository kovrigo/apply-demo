...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-custom-trix', __webpack_require__(4));
  Vue.component('detail-custom-trix', __webpack_require__(7));
  Vue.component('form-custom-trix', __webpack_require__(10));
});
  ...
  return _c(
    ...
    [
      _c("template", { slot: "field" }, [
        _c(
          "div",
          { staticClass: "trix-form", class: { disabled: _vm.isReadonly } },
          [
            _c("trix-editor", {
              ref: "theEditor",
              staticClass: "rounded-lg trix-content",
              class: { "border-danger": _vm.hasError },
              attrs: { name: "trixman", value: _vm.value },
              on: {
                ...
                "trix-attachment-add": _vm.handleFileAdd,
                "trix-attachment-remove": _vm.handleFileRemove,
