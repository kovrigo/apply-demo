...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-custom-select', __webpack_require__(3));
  Vue.component('detail-custom-select', __webpack_require__(6));
  Vue.component('form-custom-select', __webpack_require__(9));
});
          ...
          ? _c(
              ...
              [
                _vm.isReadonly
                  ...
                  : _c("multiselect", {
                      staticClass: "text-80 pb-2 leading-tight",
                      attrs: {
                        "track-by": "value",
                        label: "label",
