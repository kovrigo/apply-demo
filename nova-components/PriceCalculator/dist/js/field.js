...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-price-calculator', __webpack_require__(3));
  Vue.component('detail-price-calculator', __webpack_require__(6));
  Vue.component('form-price-calculator', __webpack_require__(9));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        handleCountChange: function handleCountChange(e) {
      ...
      _c("template", { slot: "field" }, [
        _c("div", { staticClass: "flex items-end" }, [
          _c("input", {
            ...
            attrs: { type: "number", min: "0", step: "1", placeholder: "" },
            on: { input: _vm.handleCountChange }
          }),
          _vm._v(" "),
          _c("span", { staticClass: "label mx-3" }, [
            _vm._v("x " + _vm._s(_vm.unitPrice))
          ]),
          _vm._v(" "),
          _c("span", { staticClass: "label mr-3" }, [_vm._v("=")]),
          _vm._v(" "),
          _c("input", {
            ref: "amount",
            staticClass: "custom-input ml-2 price-input",
            attrs: { type: "number", min: "0", step: "0.01", placeholder: "" },
            on: { input: _vm.handleAmountChange }
          }),
          _vm._v(" "),
          _c("span", { staticClass: "label" }, [
            _vm._v(_vm._s(_vm.field.currency.name))
          ])
        ])
      ])
    ],
