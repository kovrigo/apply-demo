...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-custom-boolean', __webpack_require__(3));
  Vue.component('detail-custom-boolean', __webpack_require__(6));
  Vue.component('form-custom-boolean', __webpack_require__(9));
});
...
var render = function() {
  ...
  return _c("div", { class: "text-" + _vm.field.textAlign }, [
    _c("span", { staticClass: "lowercase" }, [_vm._v(_vm._s(_vm.label))])
  ])
}
var staticRenderFns = []
  ...
  return _c(
    ...
    [
      _c(
        ...
        [
          _vm.isReadonly
            ? _c("div", { staticClass: "lowercase w-full h-full pt-2" }, [
                _vm._v("\n          " + _vm._s(_vm.label) + "\n      ")
              ])
            : _c("checkbox", {
                staticClass: "mt-2",
