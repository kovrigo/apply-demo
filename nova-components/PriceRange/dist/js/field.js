...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-price-range', __webpack_require__(3));
  Vue.component('detail-price-range', __webpack_require__(6));
  Vue.component('form-price-range', __webpack_require__(9));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    computed: {
        ...
        fieldValue: function fieldValue() {
            var selectedCurrency = _.find(this.field.currencies, ['id', this.field.value.currency]);
...
var render = function() {
  ...
  return _c("div", { class: "text-" + _vm.field.textAlign }, [
    _c("span", { domProps: { innerHTML: _vm._s(_vm.fieldValue) } })
  ])
}
var staticRenderFns = []
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        toggleExactAmount: function toggleExactAmount() {
      ...
      _c("template", { slot: "field" }, [
        _vm.isReadonly
          ...
          : _c("div", [
              _c("div", { staticClass: "w-full mb-4" }, [
                _c(
                  "a",
                  {
                    ...
                    class: { active: _vm.value.exact_amount },
                    on: { click: _vm.toggleExactAmount }
                  },
                  [_vm._v("\n                    точная\n                ")]
                ),
                _vm._v(" "),
                _c(
                  ...
                  {
                    staticClass:
                      "inline-block cursor-pointer animate-text-color select-none mini-tab",
                    class: { active: !_vm.value.exact_amount },
                    on: { click: _vm.toggleExactAmount }
                  },
                  [
              ...
              _vm._v(" "),
              _vm.value.exact_amount
                ? _c(
                    "div",
                    { staticClass: "mini-tab-content flex items-end" },
                    [
                      _vm.value.exact_amount
                        ? _c("input", {
                            directives: [
                            ...
                            staticClass: "custom-input price-input",
                            attrs: {
                              type: "number",
                              min: "0",
                              placeholder: ""
                      ...
                      _c("multiselect", {
                        staticClass:
                          "text-80 leading-tight ml-4 currency-selector",
                        attrs: {
                          "track-by": "id",
                          label: "name",
                          options: _vm.field.currencies,
                          "allow-empty": false
                        },
                        model: {
                ...
                : _c(
                    ...
                    [
                      !_vm.value.exact_amount
                        ? _c("span", { staticClass: "label" }, [_vm._v("от")])
                        : _vm._e(),
                      _vm._v(" "),
                      !_vm.value.exact_amount
                        ? _c("input", {
                            ...
                            staticClass: "custom-input ml-2 price-input",
                            attrs: {
                              type: "number",
                              min: "0",
                              placeholder: "",
                            ...
                            on: {
                              input: function($event) {
                                ...
                                _vm.$set(_vm.value, "min", $event.target.value)
                              }
                            }
                          })
                        : _vm._e(),
                      _vm._v(" "),
                      !_vm.value.exact_amount
                        ? _c("span", { staticClass: "separator mx-4" }, [
                            _vm._v("—")
                          ])
                        : _vm._e(),
                      _vm._v(" "),
                      !_vm.value.exact_amount
                        ? _c("span", { staticClass: "label" }, [_vm._v("до")])
                        : _vm._e(),
                      _vm._v(" "),
                      !_vm.value.exact_amount
                        ? _c("input", {
                            ...
                            on: {
                              input: function($event) {
                                ...
                                _vm.$set(_vm.value, "max", $event.target.value)
                              }
                            }
                          })
                        : _vm._e(),
                      _vm._v(" "),
                      _c("multiselect", {
                        staticClass: "ml-4 currency-selector",
                        attrs: {
                          "track-by": "id",
                          label: "name",
                          options: _vm.field.currencies,
