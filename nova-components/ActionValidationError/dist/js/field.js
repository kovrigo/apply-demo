...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-action-validation-error', __webpack_require__(3));
  Vue.component('detail-action-validation-error', __webpack_require__(6));
  Vue.component('form-action-validation-error', __webpack_require__(9));
});
    ...
    directives: [
      {
        name: "show",
        rawName: "v-show",
        value: _vm.errors.errors.hasOwnProperty(_vm.field.attribute),
        expression: "errors.errors.hasOwnProperty(field.attribute)"
      }
    ],
    staticClass: "pt-6 px-8 help-text error-text mt-2 text-danger",
    domProps: {
      innerHTML: _vm._s(
        _vm.errors.errors[_vm.field.attribute]
          ? _vm.errors.errors[_vm.field.attribute][0]
          : ""
      )
    }
  })
