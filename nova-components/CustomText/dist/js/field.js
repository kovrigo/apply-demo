...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-custom-text', __webpack_require__(3));
  Vue.component('detail-custom-text', __webpack_require__(6));
  Vue.component('form-custom-text', __webpack_require__(9));
});
