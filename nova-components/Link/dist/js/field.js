...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-link', __webpack_require__(3));
  Vue.component('detail-link', __webpack_require__(6));
  Vue.component('form-link', __webpack_require__(10));
});
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__mixins_href__ = __webpack_require__(8);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  mixins: [__WEBPACK_IMPORTED_MODULE_0__mixins_href__["a" /* default */]],
...
/* harmony default export */ __webpack_exports__["a"] = ({
    ...
    computed: {
        href: function href() {
            console.log(this);
            var url = this.field.template.replace(':resource', this.resourceName);
    ...
    [
      _c("template", { slot: "value" }, [
        _c(
          ...
          {
            staticClass:
              "no-underline dim text-primary font-bold router-link-exact-active router-link-active text-left text-left",
            attrs: { href: _vm.href, target: _vm.field.target }
          },
          [_vm._v("\n    \t" + _vm._s(_vm.field.text) + "\n    ")]
        )
      ])
    ],
    2
