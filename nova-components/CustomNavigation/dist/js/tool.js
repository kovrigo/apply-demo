...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_CustomNavigation__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_CustomNavigation___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__components_CustomNavigation__);
...
Nova.booting(function (Vue, router, store) {
  Vue.component('custom-navigation', __WEBPACK_IMPORTED_MODULE_0__components_CustomNavigation___default.a);
});
...
var update = __webpack_require__(1)("1d4c024b", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-e5a11f60\",\"scoped\":false,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./CustomNavigation.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-e5a11f60\",\"scoped\":false,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./CustomNavigation.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    mounted: function mounted() {
        ...
        _.forEach(this.navigation, function (group) {
            var expanded = localStorage.getItem(group.label);
            if (expanded === null) {
                expanded = true;
            } else {
    ...
    methods: {
        ...
        setSelectedLink: function setSelectedLink() {
            var self = this;
            _.forEach(this.navigation, function (group) {
        ...
        getLinkRoutableObject: function getLinkRoutableObject(link) {
            var isLens = this.isLinkLens(link);
            var res = {
        ...
        getLinkLabel: function getLinkLabel(link) {
            return link.label;
        },

        getLinkCount: function getLinkCount(link) {
          ...
          return _c(
            ...
            [
              _c(
                "div",
                {
                  staticClass: "group-label cursor-pointer",
                  on: {
                ...
                [
                  ...
                  group.expanded ? _c("span", [_vm._v(":")]) : _vm._e()
                ]
              ),
              _vm._v(" "),
                    ...
                    directives: [
                      {
                        ...
                        expression: "group.expanded"
                      }
                    ],
                    staticClass: "navigation-link",
                    class: _vm.getLinkClass(link)
                  },
                  [
                    !_vm.isLinkRoutable(link)
                      ? _c("a", { attrs: { href: link.url } }, [
                          _vm._v(
                            "\n                " +
                              _vm._s(_vm.getLinkLabel(link)) +
                              " " +
                              _vm._s(_vm.getLinkCount(link)) +
                              "\n            "
                          )
                        ])
                      : _c(
                          "router-link",
                          { attrs: { to: _vm.getLinkRoutableObject(link) } },
                          [
                            _vm._v(
                              "\n                " +
                                _vm._s(_vm.getLinkLabel(link)) +
...
var render = function() {
  ...
  return _c(
    "div",
    [
      _c("heading", { staticClass: "mb-6" }, [_vm._v("Custom Navigation")]),
      _vm._v(" "),
      _c(
        "card",
        {
        ...
        [
          ...
          _c("p", { staticClass: "text-white-50% text-lg" }, [
            ...
            _c(
              ...
              [
                _vm._v(
                  "\n                /nova-components/CustomNavigation/resources/js/components/Tool.vue\n            "
                )
              ]
            )
          ])
